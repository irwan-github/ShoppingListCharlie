...
//    public void onCreate(SQLiteDatabase db, String suffixTempTable)
//    {
//        if (TextUtils.isEmpty(suffixTempTable))
//        {
//            suffixTempTable = "";
//        }
//
//        // SQL statement to create the items table
//        String SQL_CREATE_ITEM_TABLE = "CREATE TABLE " +
//                suffixTempTable + ItemsEntry.TABLE_NAME + " " + "(" +
//                ItemsEntry._ID + " " + "INTEGER PRIMARY KEY AUTOINCREMENT," +
//                ItemsEntry.COLUMN_NAME + " " + "TEXT NOT NULL," +
//                ItemsEntry.COLUMN_BRAND + " " + "TEXT," +
//                ItemsEntry.COLUMN_COUNTRY_ORIGIN + " " + "TEXT," +
...
//        // SQL statement to create the price table
//        String SQL_CREATE_PRICE_TABLE = "CREATE TABLE " +
//                suffixTempTable + PricesEntry.TABLE_NAME + " " + "(" +
//                PricesEntry._ID + " " + "INTEGER PRIMARY KEY AUTOINCREMENT," +
//                PricesEntry.COLUMN_PRICE_TYPE_ID + " " + "INTEGER NOT NULL," +
//                PricesEntry.COLUMN_SHOP_ID + " " + "INTEGER NOT NULL," +
//                PricesEntry.COLUMN_PRICE + " " + "INTEGER NOT NULL," +
...
//
//        String SQL_CREATE_PICTURES_TABLE = "CREATE TABLE " +
//                suffixTempTable + PicturesEntry.TABLE_NAME + " (" +
//                PicturesEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
//                PicturesEntry.COLUMN_ITEM_ID + " INTEGER NOT NULL, " +
//                PicturesEntry.COLUMN_FILE_PATH + " TEXT NOT NULL, " +
//                PicturesEntry.COLUMN_LAST_UPDATED_ON + " " + "INTEGER, " +
...
//        // SQL statement to create the buy items table
//        String SQL_CREATE_BUY_ITEMS_TABLE = "CREATE TABLE " +
//                suffixTempTable + ToBuyItemsEntry.TABLE_NAME + " " + "(" +
//                ToBuyItemsEntry._ID + " " + "INTEGER PRIMARY KEY AUTOINCREMENT," +
//                ToBuyItemsEntry.COLUMN_ITEM_ID + " " + "INTEGER NOT NULL," +
//                ToBuyItemsEntry.COLUMN_QUANTITY + " " + "INTEGER NOT NULL," +
//                ToBuyItemsEntry.COLUMN_SELECTED_PRICE_ID + " " + "INTEGER NOT NULL," +
...
//                ")";
//
//        String SQL_CREATE_EXCHANGE_RATE_TABLE = "CREATE TABLE " +
//                ExchangeRateEntry.TABLE_NAME + " " + "(" +
//                ExchangeRateEntry._ID + " " + "INTEGER PRIMARY KEY AUTOINCREMENT," +
//                ExchangeRateEntry.COLUMN_SRC_CURRENCY_CODE + " " + "TEXT NOT NULL," +
//                ExchangeRateEntry.COLUMN_DES_CURRENCY_CODE + " " + "TEXT NOT NULL," +
//                ExchangeRateEntry.COLUMN_RATE + " " + "INTEGER NOT NULL," +
//                ExchangeRateEntry.COLUMN_LAST_UPDATED_ON + " " + "INTEGER NOT NULL" +
//                ")";
//
//        db.execSQL(SQL_CREATE_ITEM_TABLE);
//        db.execSQL(SQL_CREATE_PICTURES_TABLE);
//        db.execSQL(SQL_CREATE_PRICE_TABLE);
//        db.execSQL(SQL_CREATE_BUY_ITEMS_TABLE);
//       // db.execSQL(SQL_CREATE_EXCHANGE_RATE_TABLE);
//    }
