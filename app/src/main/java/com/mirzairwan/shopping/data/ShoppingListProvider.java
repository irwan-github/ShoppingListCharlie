...
//        sCatalogueProjectionMap.put(PricesEntry.COLUMN_SHOP_ID, PricesEntry.TABLE_NAME + "." + PricesEntry.COLUMN_SHOP_ID);
        ...
        static
        {
                ...
                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_PRICES, PRICES);

                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_PRICES + "/#", PRICE_ID);

                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_BUY_ITEMS, BUY_ITEMS);

                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_BUY_ITEMS + "/#", BUY_ITEM_ID);
                 ...
                 */
                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_PICTURES + "/#", PICTURE_ID);

                /**
                 * CONTENT_URI matcher for all items in the shopping list
                 */
                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_SHOPPING_LIST, SHOPPING_LIST);

                /**
                 * CONTENT_URI matcher for one item in the shopping list
                 * Called by buying activity on one existing item
                 */
                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_SHOPPING_LIST + "/#", SHOPPING_LIST_ITEMID);


                /**
                 * CONTENT_URI matcher for all items in the catalogue
                 */
                sUriMatcher.addURI(Contract.CONTENT_AUTHORITY, Contract.PATH_CATALOGUE, CATALOGUE);
         ...
         * 3. prices.
         * 4. pictures
         * Passing in a null selection will return duplicate item records as an item have more than one price tag. Therefore selection criteria to narrow the price should be given to avoid
         * duplicate items records. Buy items record is queried so that caller will know whether the item is already in the shopping list.
         *
         * @param uri
         * @param projection
         * @param selection
        ...
        private Cursor queryPictures(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
        {
                ...
                Cursor cursor = builder.query(mShoppingListDbHelper.getReadableDatabase(), projection, selection, selectionArgs, null, null, sortOrder);
                return cursor;
        }
...
//                    "ON buy_items.selected_price_id=prices._id
                ...
                switch (matchCode)
                {
                        ...
                        case BUY_ITEM_ID:
                                ...
                                result = mShoppingListDbHelper.getWritableDatabase().
                                        update(ToBuyItemsEntry.TABLE_NAME, values, selection, selectionArgs);
                                break;
                        default:
        ...
        private int updatePrices(Uri uri, ContentValues values, String selection, String[] selectionArgs)
        {
                return mShoppingListDbHelper.getWritableDatabase().update(PricesEntry.TABLE_NAME, values, selection, selectionArgs);
        }
        ...
        private int updateItems(Uri uri, ContentValues values, String selection, String[] selectionArgs)
        {
                int result;
                result = mShoppingListDbHelper.getWritableDatabase().
                        update(ItemsEntry.TABLE_NAME, values, selection, selectionArgs);
                return result;
        }
        ...
        public int delete(Uri uri, String selection, String[] selectionArgs)
        {
                ...
                switch (matchCode)
                {
                        ...
                        case ITEM_ID:
                                ...
                                break;
                        case BUY_ITEMS:
                                deleted = mShoppingListDbHelper.getWritableDatabase().delete(ToBuyItemsEntry.TABLE_NAME, selection, selectionArgs);
                                break;
                        case BUY_ITEM_ID:
                                _id = ContentUris.parseId(uri);
                                selection = ToBuyItemsEntry._ID + "=?";
