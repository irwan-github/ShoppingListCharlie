...
public class ShoppingListAdapter extends CursorAdapter
{
        ...
        public ShoppingListAdapter(Context context, Cursor cursor, OnCheckBuyItemListener onFragmentInteractionListener, OnPictureRequestListener onPictureRequestListener)
        {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent)
        {
                ...
                OnItemCheckedChangeListener onItemCheckedChangeListener = new OnItemCheckedChangeListener(mOnFragmentInteractionListener);
        ...
        private void setPrice(Context context, String srcCurrencyCode, double priceTag, TextView tvSelectedPrice)
        {
                ...
                {
                        tvSelectedPrice.setText(FormatHelper.formatCountryCurrency(countryCode, srcCurrencyCode, priceTag / 100));
                }
                else if (mExchangeRates != null)
                {
                        ...
                        if (exchangeRate != null)
                        {
                                ...
                                String text = FormatHelper.formatCountryCurrency(countryCode, FormatHelper.getCurrencyCode(countryCode), translatedDestVal / 100) + " (" + srcCurrencyCode + "->" +
                                        destCurrencyCode + ")";
