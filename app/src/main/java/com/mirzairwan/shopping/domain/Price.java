...
public class Price
{
         ...
         */
        public Price(double bundlePrice, int bundleQuantity, String currencyCode, long shopId)
        {
         ...
         */
        public Price(long _id, double bundlePrice, int bundleQuantity, String currencyCode, long shopId, Date lastUpdatedOn)
        {
                this._id = _id;
                mBundlePrice = bundlePrice;
                mBundleQuantity = bundleQuantity;
